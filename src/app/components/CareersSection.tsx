...
export const CareersSection = () => {
  ...
  // Generate URL-friendly ID from career title
    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {CAREER_CARDS.map((card, idx) => (
            ...
            >
              ...
              <button 
                type="button"
                onClick={() => navigate(`/careers/${generateCareerId(card.title)}`)}
        ...
        <div className="mt-20 p-12 bg-black rounded-[2rem] text-white flex flex-col md:flex-row items-center justify-between gap-8 overflow-hidden relative">
          ...
          <button type="button" className="relative z-10 px-10 py-5 bg-white text-black font-bold uppercase tracking-widest text-xs hover:bg-gray-100 transition-colors whitespace-nowrap">
            Contact Recruitment
          </button>
          {/* Decorative element */}
