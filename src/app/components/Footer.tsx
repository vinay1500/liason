          ...
          <div className="lg:col-span-2 grid grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-4 text-sm text-gray-400">
                <li 
                  onClick={() => navigate('/expertise/Corporate, Commercial and Startups')}
                  className="hover:text-blue-600 cursor-pointer transition-colors"
                >
                  Corporate, Commercial and Startups
                </li>
                <li 
                  onClick={() => navigate('/expertise/Family and Matrimonial')}
                  className="hover:text-blue-600 cursor-pointer transition-colors"
                >
                  Family and Matrimonial
                </li>
                <li 
                  onClick={() => navigate('/expertise/Property and Real Estate')}
                  className="hover:text-blue-600 cursor-pointer transition-colors"
                >
                  Property and Real Estate
                </li>
                <li 
                  onClick={() => navigate('/expertise/Criminal Matters')}
                  className="hover:text-blue-600 cursor-pointer transition-colors"
                >
                  Criminal Matters
                </li>
                <li 
                  onClick={() => navigate('/expertise/Employment & Labor')}
                  className="hover:text-blue-600 cursor-pointer transition-colors"
                >
                  Employment & Labor
                </li>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-gray-400">
                <li onClick={() => navigate('/insights')} className="hover:text-white cursor-pointer transition-colors">Legal Insights</li>
                <li onClick={() => navigate('/market-reports')} className="hover:text-white cursor-pointer transition-colors">Market Reports</li>
                <li onClick={() => navigate('/careers')} className="hover:text-white cursor-pointer transition-colors">Careers</li>
                <li onClick={() => navigate('/newsroom')} className="hover:text-white cursor-pointer transition-colors">Newsroom</li>
                <li onClick={() => navigate('/pro-bono')} className="hover:text-white cursor-pointer transition-colors">Pro Bono</li>
              </ul>
            </div>
          </div>
          ...
          <div className="relative h-full min-h-[300px] lg:min-h-0 group">
            ...
            <div className="relative w-full aspect-square bg-white/5 rounded-3xl overflow-hidden border border-white/10 group-hover:border-white/20 transition-all">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                ...
                <button type="button" className="mt-4 text-[10px] font-bold uppercase tracking-[0.2em] border-b border-white pb-1 hover:text-blue-400 transition-colors">
                  View Full Map
                </button>
              </div>
              {/* Pins on map */}
